exports.handler = async function(event) {
  ...
  try {
    ...
    var retroPrompts = [
      ...
      "Transform the entire image into a Grand Theft Auto: Vice City in-game screenshot rendered on PlayStation 2. Rebuild everything — the person, clothing, and environment — in the RenderWare engine aesthetic. The person's face stays recognisable but the skin must look exactly like a GTA Vice City 2002 PS2 character model: one single flat orange-tan skin colour filling the entire face — the exact plastic polygon tone from the original 2002 game. No smooth gradients, no blending, no pores, no wrinkles, no realistic skin detail of any kind. Visible angular polygon geometry on the face with hard-edged shadow zones — only 2 or 3 flat colour blocks for shadow, like paint on geometric shapes. Blocky jawline, hard edges on cheeks and forehead. Face looks like a low-poly 3D model painted in one solid skin tone, not a photograph or illustration. Place them in a random action scene — walking down a neon-lit Vice City street, leaning on a boxy 80s car, standing outside a club entrance, or on a sun-bleached dock. The entire scene must look uniformly like PS2 graphics — flat-shaded buildings, low-res blurry palm trees, simple boxy cars, no photorealism anywhere. 1980s Miami palette: hot pink, electric teal, burnt orange. Harsh flat directional lighting. 4:3 composition. No HUD. No health bar. No game UI of any kind.",
      // V2 — Stephen Bliss Box Art
      "Redraw the entire image as a Grand Theft Auto: Vice City promotional illustration in the exact style of artist Stephen Bliss — the original painter of all Vice City box art and loading screens. Convert the person's face and body into his iconic 2D illustrated style: thick bold black ink outlines around everything, flat cel-shaded colour fills with hard shadow edges, no photorealism, slightly exaggerated confident pose. The skin must be rendered in the flat 2D illustrated style but with the exact same orange-tan single skin tone from GTA Vice City 2002 — one flat solid skin colour with only 2 hard-edged shadow blocks, no gradients, no texture, no pores, no blending. Skin looks like the 2002 game character painted in Stephen Bliss illustration style — bold, flat, one tone. The entire image must look like a flat 2D Rockstar poster — no depth of field, no photography, pure graphic illustration. Background is a stylised 1980s Miami sunset: deep violet and magenta sky, silhouetted palm trees, neon signs. Full body portrait, confident character reveal pose. Colours are bold and blocked: hot pink, electric blue, gold, violet. No HUD. No health bar. No UI of any kind.",
      // V3 — Loading Screen Character Card
      "Redraw this entire image as a Grand Theft Auto: Vice City character loading screen illustration — the iconic splash art shown between missions. Transform everything into Stephen Bliss-inspired semi-painted 2D artwork: the person's face is recognisable but fully illustrated with bold ink outlines, flat colour blocking, hard cel-shaded shadows, and zero photorealism. The skin must use the exact flat orange-tan single skin tone of a GTA Vice City 2002 character model — one solid colour filling the face with only two hard-edged shadow zones, zero gradients, zero texture, zero pores. Skin looks like the 2002 game polygon mesh painted in a graphic illustrated style — flat, bold, one tone, like a comic painted over a low-poly 3D model. Dynamic pose — mid-stride on a Vice City boulevard, holding a phone near a luxury car, or standing on a rooftop with the city behind them. Wearing era-appropriate 1980s Miami fashion: linen suit, Hawaiian shirt, or leather jacket. Background is a graphic Vice City scene — marina at dusk, neon-lit strip, or ocean boulevard at sunset. Saturated punchy colours: coral pink, seafoam teal, golden yellow. Illustrated poster-style composition, no depth-of-field photography. No HUD. No health bar. No UI overlays of any kind."
    ];
