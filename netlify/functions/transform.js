exports.handler = async function(event) {
  ...
  try {
    ...
    var retroPrompt = "Convert this image into a 1980s vintage GTA-style digital illustration. Apply heavy black ink outlines and a vibrant cel-shaded color palette. The background should feature a hazy, neon-pink and orange sunset sky with silhouetted palm trees and retro-futuristic city grids. Use high-contrast lighting with a soft dreamy bloom effect. Maintain the exact likeness and pose of the subject, but stylize them as an 80s action protagonist with a grainy, analog paper texture overlay. Color Palette: Teal, magenta, and sun-bleached yellow. Texture: Slight film grain and chromatic aberration. Lighting: Backlit rim lighting to make the character pop against the dark city.";
    var modernPrompt = "Render the uploaded image as a photorealistic, high-fidelity screenshot from a next-gen open-world video game engine. Maintain the exact physical structure, textures, and details of the primary subjects in the original photo. Enhance the scene with cinematic Golden Hour lighting, ray-traced reflections, and realistic depth of field. The environment should be transformed into a high-detail urban or coastal city setting with volumetric atmosphere. Ensure skin, fur, or metallic surfaces have realistic shaders and subsurface scattering. Strictly no cartoon outlines or illustrative cel-shading, focus on 3D realism graphics.";
