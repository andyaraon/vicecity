exports.handler = async function(event) {
  ...
  try {
    ...
    var retroPrompts = [
      ...
      "Transform the entire image into a Grand Theft Auto: Vice City in-game screenshot rendered on PlayStation 2. Rebuild everything — the person, clothing, and environment — in the RenderWare engine aesthetic. The person's face stays recognisable but the skin must look exactly like a real PS2 character model: flat single-tone skin colour with zero smooth gradients, visible angular polygon geometry on the face, hard-edged flat shadow zones on the cheeks and forehead, blocky jawline, no pores, no realistic wrinkles, no photorealistic skin detail whatsoever — purely geometric flat-shaded polygons painted with a single skin tone. Face looks like a painted polygon mesh, not a photograph. Place them in a random action scene — walking down a neon-lit Vice City street, leaning on a boxy 80s car, standing outside a club entrance, or on a sun-bleached dock. The entire scene must look uniformly like PS2 graphics — flat-shaded buildings, low-res blurry palm trees, simple boxy cars, no photorealism anywhere. 1980s Miami palette: hot pink, electric teal, burnt orange. Harsh flat directional lighting. 4:3 composition. No HUD. No health bar. No game UI of any kind.",
      // V2 — Stephen Bliss Box Art
      "Redraw the entire image as a Grand Theft Auto: Vice City promotional illustration in the exact style of artist Stephen Bliss — the original painter of all Vice City box art and loading screens. Convert the person's face and body into his iconic 2D illustrated style: thick bold black ink outlines around everything, flat cel-shaded colour fills with hard shadow edges, no photorealism, slightly exaggerated confident pose. The skin must be rendered as flat 2D colour zones — a single solid skin tone with hard-edged shadow blocks, no gradients, no texture, no pores. Face looks painted and graphic, not photographic. The entire image must look like a flat 2D Rockstar poster — no depth of field, no photography, pure graphic illustration. Background is a stylised 1980s Miami sunset: deep violet and magenta sky, silhouetted palm trees, neon signs. Full body portrait, confident character reveal pose. Colours are bold and blocked: hot pink, electric blue, gold, violet. No HUD. No health bar. No UI of any kind.",
      // V3 — Loading Screen Character Card
      "Redraw this entire image as a Grand Theft Auto: Vice City character loading screen illustration — the iconic splash art shown between missions. Transform everything into Stephen Bliss-inspired semi-painted 2D artwork: the person's face is recognisable but fully illustrated with bold ink outlines, flat colour blocking, hard cel-shaded shadows, and zero photorealism. The skin must be flat 2D painted — a single solid skin tone block with only two or three hard shadow zones, no smooth gradients, no realistic skin texture, no pores, painted like a comic book character. Dynamic pose — mid-stride on a Vice City boulevard, holding a phone near a luxury car, or standing on a rooftop with the city behind them. Wearing era-appropriate 1980s Miami fashion: linen suit, Hawaiian shirt, or leather jacket. Background is a graphic Vice City scene — marina at dusk, neon-lit strip, or ocean boulevard at sunset. Saturated punchy colours: coral pink, seafoam teal, golden yellow. Illustrated poster-style composition, no depth-of-field photography. No HUD. No health bar. No UI overlays of any kind."
    ];
