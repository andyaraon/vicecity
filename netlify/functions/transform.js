exports.handler = async function(event) {
  ...
  try {
    ...
    var retroPrompts = [
      // V1 — PS2 In-Game Render (authentic RenderWare engine)
      "Generate a 3D model screenshot transforming the input image into the distinct retro graphical style of 2002 PlayStation 2 gaming, specifically emulating Grand Theft Auto: Vice City. Preserve the exact subject face, likeness, and pose from the source image, but render everything using primitive low-polygon geometry with highly visible polygonal edges on the face, body, and all objects. All textures must be low-resolution, unfiltered, and blocky — applying a simplified flat-shaded lighting model typical of early 2000s PS2 in-game rendering. Replace all high-fidelity details with the characteristic geometric simplifications and crudely applied texture maps of GTA Vice City RenderWare engine. Place the subject in a random Vice City environment: a neon-lit Miami boulevard at dusk, inside a boxy 80s car driving through Vice City, a sun-bleached ocean dock with flat-shaded water, or outside a low-poly nightclub entrance. The entire scene must look like an authentic in-game asset from GTA Vice City 2002 — character, environment, and lighting all uniformly PS2 quality. 4:3 aspect ratio. No HUD. No minimap. No health bar. No ammo counter. No game UI of any kind.",
